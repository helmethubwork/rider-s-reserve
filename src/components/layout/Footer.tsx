        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <Link to="/" className="flex items-center gap-1">
              <span className="text-xl font-bold text-primary italic tracking-wider">HELMET</span>
              <span className="text-xl font-bold text-foreground italic tracking-wider">HUB</span>
            </Link>
            ...
            <div className="flex gap-3">
              <a
                ...
                className="p-2 bg-card rounded text-foreground hover:text-primary hover:bg-primary/10 transition-all"
              >
                <Instagram size={20} />
              </a>
              <a
          ...
          {/* Quick Links */}
          <div className="space-y-4">
            <h4 className="text-sm font-bold text-primary tracking-wider">QUICK LINKS</h4>
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/sale" className="text-muted-foreground hover:text-primary transition-colors text-sm">
                  Sale
                </Link>
              </li>
            </ul>
          ...
          {/* Customer Service */}
          <div className="space-y-4">
            <h4 className="text-sm font-bold text-primary tracking-wider">CUSTOMER SERVICE</h4>
            <ul className="space-y-2">
              <li>
          ...
          {/* Contact */}
          <div className="space-y-4">
            <h4 className="text-sm font-bold text-primary tracking-wider">CONTACT US</h4>
