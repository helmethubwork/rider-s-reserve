/**
 * Blog Posts Seeding Utility
 * 
 * This utility seeds the blog_posts table with initial data.
...
**Remember:** A certified helmet is only effective if it fits properly. Always try before you buy!`,
    image_url: helmetCertificationsImg,
    category: 'Education',
    is_published: true,
    display_order: 4
  }
